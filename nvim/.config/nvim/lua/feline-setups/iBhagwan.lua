...
local comps = {
    ...
    diagnos = {
        err = {
            ...
            provider = function()
                return '' .. lsp_get_diag(sv.ERROR)
            end,
            -- left_sep = ' ',
            enabled = function() return lsp.diagnostics_exist(sv.ERROR) end,
            hl = {
                fg = colors.red
            }
        },
        warn = {
            ...
            provider = function()
                return '' ..  lsp_get_diag(sv.WARNING)
            end,
            -- left_sep = ' ',
            enabled = function() return lsp.diagnostics_exist(sv.WARNING) end,
            hl = {
                fg = colors.yellow
            }
        },
        info = {
            ...
            provider = function()
                return '' .. lsp_get_diag(sv.INFORMATION)
            end,
            -- left_sep = ' ',
            enabled = function() return lsp.diagnostics_exist(sv.INFORMATION) end,
            hl = {
                fg = colors.blue
            }
        },
        hint = {
            ...
            provider = function()
                return '' .. lsp_get_diag(sv.HINT)
            end,
            -- left_sep = ' ',
            enabled = function() return lsp.diagnostics_exist(sv.Hint) end,
            hl = {
                fg = colors.cyan
            }
        },
