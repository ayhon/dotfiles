...
let s:style = get(g:, 'ayuncolor', 'dark')
let g:colors_name = "ayun"
"}}}
...
let s:palette.bg           = {'dark': "#161616",  'light': "#FAFAFA",  'mirage': "#212733"}
...
" let s:palette.window_delim = {'dark': "#000000",  'light': "#CCCCCC",  'mirage': "#AAAAAA"}
let s:palette.window_delim = {'dark': "#CCCCCC",  'light':  "#222222",  'mirage': "#AAAAAA"}
...
exe "hi! VertSplit"     .s:fg_window_delim.s:bg_none        .s:fmt_none
" TODO: ↑ Change to be noticeable ↑
